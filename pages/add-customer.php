                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                            ...
                            <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                <form action="scripts/customer/add.php" id="add_customer_form" class="form-horizontal add_customer" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="customer_name" class="form-control" placeholder="Customer Name" id="customer_name" /> </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                               <textarea name="customer_address" id="" cols="30" rows="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Email</label>
                                            <div class="col-md-4">
                                                <input name="customer_email" type="email" class="form-control" placeholder="Email" id="customer_email" /> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="customer_contact" type="text" class="form-control" placeholder="Contact Number" id="customer_contact"/> </div>
                                                
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">GST_NO<span class="required"> * </span></label>
                                            <div class="col-md-4">
