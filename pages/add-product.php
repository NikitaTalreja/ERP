                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <!-- BEGIN FORM-->
<form action="scripts/product/add.php" id="add_product_form" class="form-horizontal" method="post" enctype="multipart/form-data"s>
...
<span class="required"> * </span>
                    ...
                    <div class="col-md-8">
                        <input type="text" name="product_name" id="product_name" class="form-control" placeholder="Product Name" /> </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="rate_of_sale" id="rate_of_sale" class="form-control" placeholder="Rate of Sale" />
                    </div>
                </div>
            </div>
           ...
           <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="eoq" class="form-control" placeholder="0" />
                    </div>
                </div>
            </div>
        </div>
           <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select name="supplier_id[]" id="supplier_id" class="form-control" multiple="mulitple">
                           <option ></option>
                            <?php
