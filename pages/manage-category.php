    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://localhost/erp/pages/scripts/category/edit.php" method="POST">
                        <div class="form-body">
...
<span class="required"> * </span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" type="Submit" name="edit_category" class="btn btn-primary">Submit</button>
                            </div>
...
<![endif]-->
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] == CATEGORY_EDIT_SUCCESS){
            ?>
            <script>
            toastr["success"]("You have edited successfully!", "CATEGORY EDIT!");    
