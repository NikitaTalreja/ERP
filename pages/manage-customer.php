    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://localhost/erp/pages/scripts/customer/edit.php" method="POST">
                        <div class="form-body">
...
<span class="required"> * </span>
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Customer Address
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Customer Email
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Customer Contact
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
...
<span class="required"> * </span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" type="Submit" name="edit_customer" class="btn btn-primary">Submit</button>
                            </div>
...
<![endif]-->
  ...
  "hideMethod": "fadeOut"
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] == CUSTOMER_EDIT_SUCCESS){ 
            ?>
             <script>
            toastr["success"]("You have edited successfully!", "CUSTOMER EDIT!"); 
        </script>
            <?php
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] == CUSTOMER_DELETE_SUCCESS){
            ...
            toastr["success"]("You have deleted successfully!", "Customer Delete!");
