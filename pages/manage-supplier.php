                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-red sbold uppercase">Supplierss</span>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://localhost/erp/pages/scripts/supplier/edit.php" method="POST">
                        <div class="form-body">
...
<span class="required"> * </span>
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Supplier Address
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                                    <input type="text" id="supplier_address" name="supplier_address" class="form-control" placeholder="Address" /> </div>
                            </div>

                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Supplier Email
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                                    <input type="text" id="supplier_email" name="supplier_email" class="form-control" placeholder="Email"  /> </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">Supplier Contact
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                                    <input type="text" id="supplier_contact" name="supplier_contact" class="form-control" placeholder="Contact"  /> </div>
                            </div>
                            <div class="form-group clearfix">
                                <label class="control-label col-md-4">GST NO 
<span class="required"> * </span>
</label>
                                <div class="col-md-8">
                                    <input type="text" id="gst_no" name="gst_no" class="form-control" placeholder="GST_NO"  /> </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                <button id="edit_save" type="Submit" name="edit_supplier" class="btn btn-primary">Submit</button>
                            </div>
...
<![endif]-->
  ...
  "hideMethod": "fadeOut"
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] == SUPPLIER_EDIT_SUCCESS){ 
            ?>
             <script>
            toastr["success"]("You have edited successfully!", "SUPPLIER EDIT!"); 
        </script>
            <?php
        ...
        if(isset($_SESSION['status']) && $_SESSION['status'] == SUPPLIER_DELETE_SUCCESS){
            ...
            toastr["success"]("You have deleted successfully!", "Supplier Delete!");
